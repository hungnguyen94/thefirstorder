(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('thefirstorderApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-thefirstorderApp-error');
                var entityKey = httpResponse.headers('X-thefirstorderApp-params');
                if (errorHeader) {
