package nl.tudelft.thefirstorder.config.liquibase;
 ...
 *
 * <p>The standard liquibase.integration.spring.SpringLiquibase starts Liquibase in the current thread:
 *     <ul>
 ...
 *         where it must start/restart very quickly</li>
 *     </ul>
 */
